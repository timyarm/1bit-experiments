...
- **[Dense vs MoE at 1-bit](docs/dense-vs-moe-analysis.md)** — theoretical analysis of where scale personalities favor dense over MoE and where the calculus flips. Derived from scale personality findings; no MoE experiments run yet.
